        ...
        >
          ...
          <div
            className={`${isDomLoaded ? "-translate-x-full" : "translate-x-0"
              } border-r-[1px] border-primary-mono3 backdrop-blur-sm absolute top-0 left-0 w-1/2 h-full z-30 transition-transform duration-1000 ease-in-out`}
          >
            <Image
          ...
          <div
            className={`${isDomLoaded ? "translate-x-full" : "translate-x-0"
              } border-l-[1px] border-primary-mono3 backdrop-blur-sm absolute top-0 right-0 w-1/2 h-full z-30 transition-transform duration-1000 ease-in-out`}
          >
            <Image
              src="/assets/images/floral/16.webp"
              alt="Bunga 1"
          ...
          <div className="relative h-screen w-full z-20 text-white">
            <div className="w-full absolute top-28 left-1/2 transform -translate-x-1/2">
              <div className="flex flex-col items-center justify-center gap-14">
                ...
                <h1
                  className={`leading-20 transform -rotate-[27deg] ${amalfiCoast.className} text-5xl text-primary-mono3 tracking-widest font-light italic`}
                >
